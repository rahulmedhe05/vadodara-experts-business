...
export const metadata: Metadata = {
  title: "EIA consultancy in Vadodara | ISO Certification Consultancy | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/iso-certification-consultancy/eia-consultancy-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/iso-certification-consultancy/eia-consultancy-vadodara",
