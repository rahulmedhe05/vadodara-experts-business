...
export const metadata: Metadata = {
  title: "DPR preparation in Vadodara | Industrial Project Consultancy | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/industrial-project-consultancy/dpr-preparation-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/industrial-project-consultancy/dpr-preparation-vadodara",
