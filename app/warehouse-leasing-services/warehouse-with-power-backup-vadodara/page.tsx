...
export const metadata: Metadata = {
  title: "warehouse with power backup in Vadodara | Warehouse Leasing Services | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/warehouse-leasing-services/warehouse-with-power-backup-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/warehouse-leasing-services/warehouse-with-power-backup-vadodara",
