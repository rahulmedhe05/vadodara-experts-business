...
export const metadata: Metadata = {
  title: "chemical warehouse in Vadodara | Warehouse Leasing Services | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/warehouse-leasing-services/chemical-warehouse-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/warehouse-leasing-services/chemical-warehouse-vadodara",
