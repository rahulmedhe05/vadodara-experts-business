...
export const metadata: Metadata = {
  title: "warehouse with dock in Vadodara | Warehouse Leasing Services | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/warehouse-leasing-services/warehouse-with-dock-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/warehouse-leasing-services/warehouse-with-dock-vadodara",
