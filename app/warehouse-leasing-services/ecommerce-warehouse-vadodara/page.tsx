...
export const metadata: Metadata = {
  title: "ecommerce warehouse in Vadodara | Warehouse Leasing Services | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/warehouse-leasing-services/ecommerce-warehouse-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/warehouse-leasing-services/ecommerce-warehouse-vadodara",
