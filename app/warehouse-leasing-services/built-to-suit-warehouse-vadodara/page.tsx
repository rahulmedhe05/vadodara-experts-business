...
export const metadata: Metadata = {
  title: "built to suit warehouse in Vadodara | Warehouse Leasing Services | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/warehouse-leasing-services/built-to-suit-warehouse-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/warehouse-leasing-services/built-to-suit-warehouse-vadodara",
