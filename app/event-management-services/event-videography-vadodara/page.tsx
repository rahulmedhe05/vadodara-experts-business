...
export const metadata: Metadata = {
  title: "Event videography in Vadodara | Event Management Services | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/event-management-services/event-videography-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/event-management-services/event-videography-vadodara",
