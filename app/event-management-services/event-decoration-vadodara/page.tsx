...
export const metadata: Metadata = {
  title: "Event decoration in Vadodara | Event Management Services | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/event-management-services/event-decoration-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/event-management-services/event-decoration-vadodara",
