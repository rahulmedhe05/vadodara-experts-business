...
export const metadata: Metadata = {
  title: "Hindu wedding planner in Vadodara | Event Management Services | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/event-management-services/hindu-wedding-planner-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/event-management-services/hindu-wedding-planner-vadodara",
