...
export const metadata: Metadata = {
  title: "semen analysis in Vadodara | IVF Clinics | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/ivf-clinics/semen-analysis-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/ivf-clinics/semen-analysis-vadodara",
