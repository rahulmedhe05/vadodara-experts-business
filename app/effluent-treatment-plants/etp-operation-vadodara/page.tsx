...
export const metadata: Metadata = {
  title: "ETP operation in Vadodara | Effluent Treatment Plants | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/effluent-treatment-plants/etp-operation-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/effluent-treatment-plants/etp-operation-vadodara",
