...
export const metadata: Metadata = {
  title: "Route optimization in Vadodara | Supply Chain Consultancy | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/supply-chain-consultancy/route-optimization-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/supply-chain-consultancy/route-optimization-vadodara",
