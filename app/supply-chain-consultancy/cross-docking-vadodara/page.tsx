...
export const metadata: Metadata = {
  title: "Cross docking in Vadodara | Supply Chain Consultancy | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/supply-chain-consultancy/cross-docking-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/supply-chain-consultancy/cross-docking-vadodara",
