...
export const metadata: Metadata = {
  title: "Tax planning in Vadodara | Chartered Accountant Services | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/chartered-accountant-services/tax-planning-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/chartered-accountant-services/tax-planning-vadodara",
