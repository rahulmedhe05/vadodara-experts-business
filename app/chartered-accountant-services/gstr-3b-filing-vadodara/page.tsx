...
export const metadata: Metadata = {
  title: "GSTR 3B filing in Vadodara | Chartered Accountant Services | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/chartered-accountant-services/gstr-3b-filing-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/chartered-accountant-services/gstr-3b-filing-vadodara",
