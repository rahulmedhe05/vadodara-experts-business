...
export const metadata: Metadata = {
  title: "OPC registration in Vadodara | Chartered Accountant Services | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/chartered-accountant-services/opc-registration-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/chartered-accountant-services/opc-registration-vadodara",
