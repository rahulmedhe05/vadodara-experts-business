...
export const metadata: Metadata = {
  title: "Electrical inspection in Vadodara | Electrical Services | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/electrical-services/electrical-inspection-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/electrical-services/electrical-inspection-vadodara",
