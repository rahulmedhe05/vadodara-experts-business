...
export const metadata: Metadata = {
  title: "PEB structure in Vadodara | PEB Building Construction | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/peb-building-construction/peb-structure-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/peb-building-construction/peb-structure-vadodara",
