...
export const metadata: Metadata = {
  title: "PEB warehouse in Vadodara | PEB Building Construction | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/peb-building-construction/peb-warehouse-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/peb-building-construction/peb-warehouse-vadodara",
