...
export const metadata: Metadata = {
  title: "PEB shed in Vadodara | PEB Building Construction | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/peb-building-construction/peb-shed-vadodara" },
  openGraph: {
    title: "PEB shed in Vadodara | VadodaraExperts",
    description: "Professional peb shed services in Vadodara from verified experts.",
    url: "https://vadodaraexperts.com/peb-building-construction/peb-shed-vadodara",
