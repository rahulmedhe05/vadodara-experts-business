...
export const metadata: Metadata = {
  title: "PEB erection in Vadodara | PEB Building Construction | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/peb-building-construction/peb-erection-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/peb-building-construction/peb-erection-vadodara",
