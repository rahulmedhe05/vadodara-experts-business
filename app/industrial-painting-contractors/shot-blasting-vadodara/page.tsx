...
export const metadata: Metadata = {
  title: "shot blasting in Vadodara | Industrial Painting Contractors | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/industrial-painting-contractors/shot-blasting-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/industrial-painting-contractors/shot-blasting-vadodara",
