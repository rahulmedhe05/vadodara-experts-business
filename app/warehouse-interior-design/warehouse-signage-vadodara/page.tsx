...
export const metadata: Metadata = {
  title: "warehouse signage in Vadodara | Warehouse Interior Design | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/warehouse-interior-design/warehouse-signage-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/warehouse-interior-design/warehouse-signage-vadodara",
