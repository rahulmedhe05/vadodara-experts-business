...
export const metadata: Metadata = {
  title: "Tenant verification in Vadodara | Real Estate Agents | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/real-estate-agents/tenant-verification-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/real-estate-agents/tenant-verification-vadodara",
