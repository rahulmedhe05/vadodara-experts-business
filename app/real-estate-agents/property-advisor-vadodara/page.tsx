...
export const metadata: Metadata = {
  title: "Property advisor in Vadodara | Real Estate Agents | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/real-estate-agents/property-advisor-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/real-estate-agents/property-advisor-vadodara",
