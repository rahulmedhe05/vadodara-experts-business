...
export const metadata: Metadata = {
  title: "Property consultant in Vadodara | Real Estate Agents | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/real-estate-agents/property-consultant-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/real-estate-agents/property-consultant-vadodara",
