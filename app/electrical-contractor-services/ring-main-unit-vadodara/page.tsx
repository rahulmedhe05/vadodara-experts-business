...
export const metadata: Metadata = {
  title: "ring main unit in Vadodara | Electrical Contractor Services | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/electrical-contractor-services/ring-main-unit-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/electrical-contractor-services/ring-main-unit-vadodara",
