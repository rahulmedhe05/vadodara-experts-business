...
export const metadata: Metadata = {
  title: "capacitor bank installation in Vadodara | Electrical Contractor Services | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/electrical-contractor-services/capacitor-bank-installation-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/electrical-contractor-services/capacitor-bank-installation-vadodara",
