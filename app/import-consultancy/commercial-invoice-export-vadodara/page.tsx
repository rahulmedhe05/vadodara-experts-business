...
export const metadata: Metadata = {
  title: "Commercial invoice export in Vadodara | Import Consultancy | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/import-consultancy/commercial-invoice-export-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/import-consultancy/commercial-invoice-export-vadodara",
