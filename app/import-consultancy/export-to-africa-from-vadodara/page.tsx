...
export const metadata: Metadata = {
  title: "Export to Africa from in Vadodara | Import Consultancy | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/import-consultancy/export-to-africa-from-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/import-consultancy/export-to-africa-from-vadodara",
