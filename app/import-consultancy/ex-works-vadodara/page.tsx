...
export const metadata: Metadata = {
  title: "Ex-works in Vadodara | Import Consultancy | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/import-consultancy/ex-works-vadodara" },
  openGraph: {
    title: "Ex-works in Vadodara | VadodaraExperts",
    description: "Professional ex-works services in Vadodara from verified experts.",
    url: "https://vadodaraexperts.com/import-consultancy/ex-works-vadodara",
