...
export const metadata: Metadata = {
  title: "Export to UK from in Vadodara | Import Consultancy | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/import-consultancy/export-to-uk-from-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/import-consultancy/export-to-uk-from-vadodara",
