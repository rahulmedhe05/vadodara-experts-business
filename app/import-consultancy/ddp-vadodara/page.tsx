...
export const metadata: Metadata = {
  title: "DDP in Vadodara | Import Consultancy | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/import-consultancy/ddp-vadodara" },
  openGraph: {
    title: "DDP in Vadodara | VadodaraExperts",
    description: "Professional ddp services in Vadodara from verified experts.",
    url: "https://vadodaraexperts.com/import-consultancy/ddp-vadodara",
