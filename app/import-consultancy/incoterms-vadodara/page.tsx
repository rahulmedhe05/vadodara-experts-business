...
export const metadata: Metadata = {
  title: "Incoterms in Vadodara | Import Consultancy | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/import-consultancy/incoterms-vadodara" },
  openGraph: {
    title: "Incoterms in Vadodara | VadodaraExperts",
    description: "Professional incoterms services in Vadodara from verified experts.",
    url: "https://vadodaraexperts.com/import-consultancy/incoterms-vadodara",
