...
export const metadata: Metadata = {
  title: "energy audit in Vadodara | Energy Audit Consultancy | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/energy-audit-consultancy/energy-audit-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/energy-audit-consultancy/energy-audit-vadodara",
