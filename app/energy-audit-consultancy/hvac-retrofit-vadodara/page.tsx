...
export const metadata: Metadata = {
  title: "HVAC retrofit in Vadodara | Energy Audit Consultancy | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/energy-audit-consultancy/hvac-retrofit-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/energy-audit-consultancy/hvac-retrofit-vadodara",
