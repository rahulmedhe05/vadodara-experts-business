...
export const metadata: Metadata = {
  title: "energy conservation building code in Vadodara | Energy Audit Consultancy | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/energy-audit-consultancy/energy-conservation-building-code-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/energy-audit-consultancy/energy-conservation-building-code-vadodara",
