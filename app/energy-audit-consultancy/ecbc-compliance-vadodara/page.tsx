...
export const metadata: Metadata = {
  title: "ECBC compliance in Vadodara | Energy Audit Consultancy | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/energy-audit-consultancy/ecbc-compliance-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/energy-audit-consultancy/ecbc-compliance-vadodara",
