...
export const metadata: Metadata = {
  title: "energy monitoring system in Vadodara | Energy Audit Consultancy | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/energy-audit-consultancy/energy-monitoring-system-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/energy-audit-consultancy/energy-monitoring-system-vadodara",
