...
export const metadata: Metadata = {
  title: "mixer tap installation in Vadodara | Plumbing Contractors | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/plumbing-contractors/mixer-tap-installation-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/plumbing-contractors/mixer-tap-installation-vadodara",
