...
export const metadata: Metadata = {
  title: "bathtub installation in Vadodara | Plumbing Contractors | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/plumbing-contractors/bathtub-installation-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/plumbing-contractors/bathtub-installation-vadodara",
