...
export const metadata: Metadata = {
  title: "kitchen plumbing in Vadodara | Plumbing Contractors | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/plumbing-contractors/kitchen-plumbing-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/plumbing-contractors/kitchen-plumbing-vadodara",
