...
export const metadata: Metadata = {
  title: "plumbing services in Vadodara | Plumbing Contractors | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/plumbing-contractors/plumbing-services-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/plumbing-contractors/plumbing-services-vadodara",
