...
export const metadata: Metadata = {
  title: "plumbing AMC in Vadodara | Plumbing Contractors | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/plumbing-contractors/plumbing-amc-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/plumbing-contractors/plumbing-amc-vadodara",
