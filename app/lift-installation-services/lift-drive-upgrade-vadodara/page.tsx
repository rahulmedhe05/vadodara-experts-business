...
export const metadata: Metadata = {
  title: "Lift drive upgrade in Vadodara | Lift Installation Services | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/lift-installation-services/lift-drive-upgrade-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/lift-installation-services/lift-drive-upgrade-vadodara",
