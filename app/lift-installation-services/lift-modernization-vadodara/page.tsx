...
export const metadata: Metadata = {
  title: "Lift modernization in Vadodara | Lift Installation Services | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/lift-installation-services/lift-modernization-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/lift-installation-services/lift-modernization-vadodara",
