...
export const metadata: Metadata = {
  title: "Rooftop garden in Vadodara | Terrace Garden Services | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/terrace-garden-services/rooftop-garden-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/terrace-garden-services/rooftop-garden-vadodara",
