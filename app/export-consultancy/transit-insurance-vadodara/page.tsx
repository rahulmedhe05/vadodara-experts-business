...
export const metadata: Metadata = {
  title: "Transit insurance in Vadodara | Export Consultancy | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/export-consultancy/transit-insurance-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/export-consultancy/transit-insurance-vadodara",
