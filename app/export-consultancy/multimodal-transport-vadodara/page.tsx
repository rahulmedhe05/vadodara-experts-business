...
export const metadata: Metadata = {
  title: "Multimodal transport in Vadodara | Export Consultancy | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/export-consultancy/multimodal-transport-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/export-consultancy/multimodal-transport-vadodara",
