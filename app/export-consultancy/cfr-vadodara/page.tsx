...
export const metadata: Metadata = {
  title: "CFR in Vadodara | Export Consultancy | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/export-consultancy/cfr-vadodara" },
  openGraph: {
    title: "CFR in Vadodara | VadodaraExperts",
    description: "Professional cfr services in Vadodara from verified experts.",
    url: "https://vadodaraexperts.com/export-consultancy/cfr-vadodara",
