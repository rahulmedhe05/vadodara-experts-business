...
export const metadata: Metadata = {
  title: "EEFC account in Vadodara | Export Consultancy | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/export-consultancy/eefc-account-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/export-consultancy/eefc-account-vadodara",
