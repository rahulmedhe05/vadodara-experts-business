...
export const metadata: Metadata = {
  title: "HS code classification in Vadodara | Export Consultancy | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/export-consultancy/hs-code-classification-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/export-consultancy/hs-code-classification-vadodara",
