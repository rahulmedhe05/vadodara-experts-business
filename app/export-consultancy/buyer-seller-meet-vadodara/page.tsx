...
export const metadata: Metadata = {
  title: "Buyer seller meet in Vadodara | Export Consultancy | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/export-consultancy/buyer-seller-meet-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/export-consultancy/buyer-seller-meet-vadodara",
