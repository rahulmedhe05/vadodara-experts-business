...
export const metadata: Metadata = {
  title: "SWIFT payment in Vadodara | Export Consultancy | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/export-consultancy/swift-payment-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/export-consultancy/swift-payment-vadodara",
