...
export const metadata: Metadata = {
  title: "Free trade zone in Vadodara | Export Consultancy | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/export-consultancy/free-trade-zone-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/export-consultancy/free-trade-zone-vadodara",
