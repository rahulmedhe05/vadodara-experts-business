...
export const metadata: Metadata = {
  title: "Wire transfer in Vadodara | Export Consultancy | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/export-consultancy/wire-transfer-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/export-consultancy/wire-transfer-vadodara",
