...
export const metadata: Metadata = {
  title: "Foreign trade policy in Vadodara | Export Consultancy | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/export-consultancy/foreign-trade-policy-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/export-consultancy/foreign-trade-policy-vadodara",
