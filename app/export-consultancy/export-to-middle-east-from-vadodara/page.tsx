...
export const metadata: Metadata = {
  title: "Export to Middle East from in Vadodara | Export Consultancy | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/export-consultancy/export-to-middle-east-from-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/export-consultancy/export-to-middle-east-from-vadodara",
