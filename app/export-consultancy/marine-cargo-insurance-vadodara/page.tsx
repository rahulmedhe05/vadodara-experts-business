...
export const metadata: Metadata = {
  title: "Marine cargo insurance in Vadodara | Export Consultancy | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/export-consultancy/marine-cargo-insurance-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/export-consultancy/marine-cargo-insurance-vadodara",
