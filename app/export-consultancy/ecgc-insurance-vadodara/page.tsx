...
export const metadata: Metadata = {
  title: "ECGC insurance in Vadodara | Export Consultancy | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/export-consultancy/ecgc-insurance-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/export-consultancy/ecgc-insurance-vadodara",
