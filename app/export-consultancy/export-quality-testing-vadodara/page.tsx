...
export const metadata: Metadata = {
  title: "Export quality testing in Vadodara | Export Consultancy | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/export-consultancy/export-quality-testing-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/export-consultancy/export-quality-testing-vadodara",
