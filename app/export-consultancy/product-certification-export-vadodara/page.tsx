...
export const metadata: Metadata = {
  title: "Product certification export in Vadodara | Export Consultancy | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/export-consultancy/product-certification-export-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/export-consultancy/product-certification-export-vadodara",
