...
export const metadata: Metadata = {
  title: "Sea freight in Vadodara | Export Consultancy | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/export-consultancy/sea-freight-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/export-consultancy/sea-freight-vadodara",
