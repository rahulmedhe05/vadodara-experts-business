...
export const metadata: Metadata = {
  title: "Exporter registration in Vadodara | Export Consultancy | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/export-consultancy/exporter-registration-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/export-consultancy/exporter-registration-vadodara",
