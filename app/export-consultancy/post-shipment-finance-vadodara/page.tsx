...
export const metadata: Metadata = {
  title: "Post-shipment finance in Vadodara | Export Consultancy | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/export-consultancy/post-shipment-finance-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/export-consultancy/post-shipment-finance-vadodara",
