...
export const metadata: Metadata = {
  title: "Duty drawback in Vadodara | Export Consultancy | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/export-consultancy/duty-drawback-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/export-consultancy/duty-drawback-vadodara",
