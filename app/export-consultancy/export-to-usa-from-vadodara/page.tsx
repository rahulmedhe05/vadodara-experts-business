...
export const metadata: Metadata = {
  title: "Export to USA from in Vadodara | Export Consultancy | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/export-consultancy/export-to-usa-from-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/export-consultancy/export-to-usa-from-vadodara",
