...
export const metadata: Metadata = {
  title: "Export market research in Vadodara | Export Consultancy | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/export-consultancy/export-market-research-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/export-consultancy/export-market-research-vadodara",
