...
export const metadata: Metadata = {
  title: "IEC registration in Vadodara | Export Consultancy | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/export-consultancy/iec-registration-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/export-consultancy/iec-registration-vadodara",
