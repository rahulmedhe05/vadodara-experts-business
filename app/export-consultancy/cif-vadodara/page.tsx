...
export const metadata: Metadata = {
  title: "CIF in Vadodara | Export Consultancy | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/export-consultancy/cif-vadodara" },
  openGraph: {
    title: "CIF in Vadodara | VadodaraExperts",
    description: "Professional cif services in Vadodara from verified experts.",
    url: "https://vadodaraexperts.com/export-consultancy/cif-vadodara",
