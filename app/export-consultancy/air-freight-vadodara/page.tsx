...
export const metadata: Metadata = {
  title: "Air freight in Vadodara | Export Consultancy | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/export-consultancy/air-freight-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/export-consultancy/air-freight-vadodara",
