...
export const metadata: Metadata = {
  title: "Foreign trade consultant in Vadodara | Export Consultancy | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/export-consultancy/foreign-trade-consultant-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/export-consultancy/foreign-trade-consultant-vadodara",
