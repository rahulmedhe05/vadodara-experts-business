...
export const metadata: Metadata = {
  title: "Bonded warehouse in Vadodara | Export Consultancy | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/export-consultancy/bonded-warehouse-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/export-consultancy/bonded-warehouse-vadodara",
