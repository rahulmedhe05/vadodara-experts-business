...
export const metadata: Metadata = {
  title: "Export promotion scheme in Vadodara | Export Consultancy | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/export-consultancy/export-promotion-scheme-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/export-consultancy/export-promotion-scheme-vadodara",
