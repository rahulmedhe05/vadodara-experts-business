...
export const metadata: Metadata = {
  title: "DAP in Vadodara | Export Consultancy | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/export-consultancy/dap-vadodara" },
  openGraph: {
    title: "DAP in Vadodara | VadodaraExperts",
    description: "Professional dap services in Vadodara from verified experts.",
    url: "https://vadodaraexperts.com/export-consultancy/dap-vadodara",
