...
export const metadata: Metadata = {
  title: "Importer registration in Vadodara | Export Consultancy | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/export-consultancy/importer-registration-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/export-consultancy/importer-registration-vadodara",
