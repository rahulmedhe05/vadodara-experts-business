...
export const metadata: Metadata = {
  title: "ITC HS code in Vadodara | Export Consultancy | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/export-consultancy/itc-hs-code-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/export-consultancy/itc-hs-code-vadodara",
