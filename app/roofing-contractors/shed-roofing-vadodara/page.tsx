...
export const metadata: Metadata = {
  title: "shed roofing in Vadodara | Roofing Contractors | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/roofing-contractors/shed-roofing-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/roofing-contractors/shed-roofing-vadodara",
