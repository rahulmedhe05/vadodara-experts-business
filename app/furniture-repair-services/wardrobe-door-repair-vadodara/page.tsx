...
export const metadata: Metadata = {
  title: "Wardrobe door repair in Vadodara | Furniture Repair Services | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/furniture-repair-services/wardrobe-door-repair-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/furniture-repair-services/wardrobe-door-repair-vadodara",
