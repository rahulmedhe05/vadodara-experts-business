...
export const metadata: Metadata = {
  title: "Sustainable architecture in Vadodara | Architecture Firms | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/architecture-firms/sustainable-architecture-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/architecture-firms/sustainable-architecture-vadodara",
