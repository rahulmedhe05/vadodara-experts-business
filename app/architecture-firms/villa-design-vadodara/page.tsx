...
export const metadata: Metadata = {
  title: "Villa design in Vadodara | Architecture Firms | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/architecture-firms/villa-design-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/architecture-firms/villa-design-vadodara",
