...
export const metadata: Metadata = {
  title: "Co working space design in Vadodara | Architecture Firms | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/architecture-firms/co-working-space-design-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/architecture-firms/co-working-space-design-vadodara",
