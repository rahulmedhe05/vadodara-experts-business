...
export const metadata: Metadata = {
  title: "GRIHA rating in Vadodara | Architecture Firms | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/architecture-firms/griha-rating-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/architecture-firms/griha-rating-vadodara",
