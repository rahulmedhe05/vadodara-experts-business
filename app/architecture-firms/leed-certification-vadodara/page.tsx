...
export const metadata: Metadata = {
  title: "LEED certification in Vadodara | Architecture Firms | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/architecture-firms/leed-certification-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/architecture-firms/leed-certification-vadodara",
