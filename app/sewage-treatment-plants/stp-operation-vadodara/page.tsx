...
export const metadata: Metadata = {
  title: "STP operation in Vadodara | Sewage Treatment Plants | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/sewage-treatment-plants/stp-operation-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/sewage-treatment-plants/stp-operation-vadodara",
