...
export const metadata: Metadata = {
  title: "fire fighting pipeline in Vadodara | Pipeline Installation Services | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/pipeline-installation-services/fire-fighting-pipeline-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/pipeline-installation-services/fire-fighting-pipeline-vadodara",
