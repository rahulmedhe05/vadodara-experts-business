...
export const metadata: Metadata = {
  title: "sewage pipeline in Vadodara | Pipeline Installation Services | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/pipeline-installation-services/sewage-pipeline-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/pipeline-installation-services/sewage-pipeline-vadodara",
