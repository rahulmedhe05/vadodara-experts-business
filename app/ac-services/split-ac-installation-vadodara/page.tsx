...
export const metadata: Metadata = {
  title: "Split AC installation in Vadodara | AC Services | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/ac-services/split-ac-installation-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/ac-services/split-ac-installation-vadodara",
