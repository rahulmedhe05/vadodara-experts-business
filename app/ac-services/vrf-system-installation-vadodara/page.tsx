...
export const metadata: Metadata = {
  title: "VRF system installation in Vadodara | AC Services | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/ac-services/vrf-system-installation-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/ac-services/vrf-system-installation-vadodara",
