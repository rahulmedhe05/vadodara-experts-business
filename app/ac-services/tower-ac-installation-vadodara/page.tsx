...
export const metadata: Metadata = {
  title: "Tower AC installation in Vadodara | AC Services | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/ac-services/tower-ac-installation-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/ac-services/tower-ac-installation-vadodara",
