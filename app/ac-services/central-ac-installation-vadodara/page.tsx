...
export const metadata: Metadata = {
  title: "Central AC installation in Vadodara | AC Services | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/ac-services/central-ac-installation-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/ac-services/central-ac-installation-vadodara",
