...
export const metadata: Metadata = {
  title: "Cassette AC installation in Vadodara | AC Services | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/ac-services/cassette-ac-installation-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/ac-services/cassette-ac-installation-vadodara",
