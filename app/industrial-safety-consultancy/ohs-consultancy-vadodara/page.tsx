...
export const metadata: Metadata = {
  title: "OHS consultancy in Vadodara | Industrial Safety Consultancy | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/industrial-safety-consultancy/ohs-consultancy-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/industrial-safety-consultancy/ohs-consultancy-vadodara",
