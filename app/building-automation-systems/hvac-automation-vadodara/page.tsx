...
export const metadata: Metadata = {
  title: "HVAC automation in Vadodara | Building Automation Systems | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/building-automation-systems/hvac-automation-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/building-automation-systems/hvac-automation-vadodara",
