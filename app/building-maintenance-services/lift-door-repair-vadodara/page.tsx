...
export const metadata: Metadata = {
  title: "Lift door repair in Vadodara | Building Maintenance Services | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/building-maintenance-services/lift-door-repair-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/building-maintenance-services/lift-door-repair-vadodara",
