...
export const metadata: Metadata = {
  title: "CCTV maintenance in Vadodara | Building Maintenance Services | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/building-maintenance-services/cctv-maintenance-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/building-maintenance-services/cctv-maintenance-vadodara",
