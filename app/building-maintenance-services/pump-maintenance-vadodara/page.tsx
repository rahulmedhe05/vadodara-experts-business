...
export const metadata: Metadata = {
  title: "Pump maintenance in Vadodara | Building Maintenance Services | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/building-maintenance-services/pump-maintenance-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/building-maintenance-services/pump-maintenance-vadodara",
