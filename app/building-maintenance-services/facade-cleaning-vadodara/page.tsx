...
export const metadata: Metadata = {
  title: "Facade cleaning in Vadodara | Building Maintenance Services | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/building-maintenance-services/facade-cleaning-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/building-maintenance-services/facade-cleaning-vadodara",
