...
export const metadata: Metadata = {
  title: "ESI registration in Vadodara | Company Registration Services | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/company-registration-services/esi-registration-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/company-registration-services/esi-registration-vadodara",
