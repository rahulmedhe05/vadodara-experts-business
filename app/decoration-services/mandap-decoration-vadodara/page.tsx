...
export const metadata: Metadata = {
  title: "Mandap decoration in Vadodara | Decoration Services | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/decoration-services/mandap-decoration-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/decoration-services/mandap-decoration-vadodara",
