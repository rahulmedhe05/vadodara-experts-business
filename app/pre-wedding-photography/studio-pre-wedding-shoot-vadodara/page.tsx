...
export const metadata: Metadata = {
  title: "Studio pre wedding shoot in Vadodara | Pre-Wedding Photography | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/pre-wedding-photography/studio-pre-wedding-shoot-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/pre-wedding-photography/studio-pre-wedding-shoot-vadodara",
