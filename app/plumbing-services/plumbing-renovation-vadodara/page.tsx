...
export const metadata: Metadata = {
  title: "Plumbing renovation in Vadodara | Plumbing Services | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/plumbing-services/plumbing-renovation-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/plumbing-services/plumbing-renovation-vadodara",
