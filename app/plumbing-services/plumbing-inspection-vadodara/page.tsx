...
export const metadata: Metadata = {
  title: "Plumbing inspection in Vadodara | Plumbing Services | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/plumbing-services/plumbing-inspection-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/plumbing-services/plumbing-inspection-vadodara",
