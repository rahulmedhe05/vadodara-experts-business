...
export const metadata: Metadata = {
  title: "24 hour plumber in Vadodara | Plumbing Services | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/plumbing-services/24-hour-plumber-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/plumbing-services/24-hour-plumber-vadodara",
