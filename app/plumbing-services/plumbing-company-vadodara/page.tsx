...
export const metadata: Metadata = {
  title: "Plumbing company in Vadodara | Plumbing Services | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/plumbing-services/plumbing-company-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/plumbing-services/plumbing-company-vadodara",
