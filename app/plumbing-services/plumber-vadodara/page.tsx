...
export const metadata: Metadata = {
  title: "Plumber in Vadodara | Plumbing Services | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/plumbing-services/plumber-vadodara" },
  openGraph: {
    title: "Plumber in Vadodara | VadodaraExperts",
    description: "Professional plumber services in Vadodara from verified experts.",
    url: "https://vadodaraexperts.com/plumbing-services/plumber-vadodara",
