...
export const metadata: Metadata = {
  title: "Booster pump installation in Vadodara | Plumbing Services | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/plumbing-services/booster-pump-installation-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/plumbing-services/booster-pump-installation-vadodara",
