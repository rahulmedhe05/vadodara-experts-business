...
export const metadata: Metadata = {
  title: "Emergency plumber in Vadodara | Plumbing Services | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/plumbing-services/emergency-plumber-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/plumbing-services/emergency-plumber-vadodara",
