...
export const metadata: Metadata = {
  title: "facade inspection in Vadodara | Building Inspection Services | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/building-inspection-services/facade-inspection-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/building-inspection-services/facade-inspection-vadodara",
