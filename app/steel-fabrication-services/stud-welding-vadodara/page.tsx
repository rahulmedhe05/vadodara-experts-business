...
export const metadata: Metadata = {
  title: "stud welding in Vadodara | Steel Fabrication Services | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/steel-fabrication-services/stud-welding-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/steel-fabrication-services/stud-welding-vadodara",
