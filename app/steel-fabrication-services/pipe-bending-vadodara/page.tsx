...
export const metadata: Metadata = {
  title: "pipe bending in Vadodara | Steel Fabrication Services | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/steel-fabrication-services/pipe-bending-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/steel-fabrication-services/pipe-bending-vadodara",
