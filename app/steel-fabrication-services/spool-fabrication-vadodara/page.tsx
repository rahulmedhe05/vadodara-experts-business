...
export const metadata: Metadata = {
  title: "spool fabrication in Vadodara | Steel Fabrication Services | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/steel-fabrication-services/spool-fabrication-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/steel-fabrication-services/spool-fabrication-vadodara",
