...
export const metadata: Metadata = {
  title: "fire damper in Vadodara | Fire Safety Installation | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/fire-safety-installation/fire-damper-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/fire-safety-installation/fire-damper-vadodara",
