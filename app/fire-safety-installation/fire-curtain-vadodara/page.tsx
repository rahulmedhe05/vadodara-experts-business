...
export const metadata: Metadata = {
  title: "fire curtain in Vadodara | Fire Safety Installation | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/fire-safety-installation/fire-curtain-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/fire-safety-installation/fire-curtain-vadodara",
