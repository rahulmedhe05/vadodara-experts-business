...
export const metadata: Metadata = {
  title: "fire extinguisher in Vadodara | Fire Safety Installation | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/fire-safety-installation/fire-extinguisher-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/fire-safety-installation/fire-extinguisher-vadodara",
