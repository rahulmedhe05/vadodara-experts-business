...
export const metadata: Metadata = {
  title: "server room design in Vadodara | Office Interior Design | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/office-interior-design/server-room-design-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/office-interior-design/server-room-design-vadodara",
