...
export const metadata: Metadata = {
  title: "GSTR 1 filing in Vadodara | GST Consultancy | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/gst-consultancy/gstr-1-filing-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/gst-consultancy/gstr-1-filing-vadodara",
