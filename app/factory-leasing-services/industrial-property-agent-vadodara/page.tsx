...
export const metadata: Metadata = {
  title: "industrial property agent in Vadodara | Factory Leasing Services | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/factory-leasing-services/industrial-property-agent-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/factory-leasing-services/industrial-property-agent-vadodara",
