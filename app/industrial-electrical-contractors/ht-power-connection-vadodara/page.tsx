...
export const metadata: Metadata = {
  title: "HT power connection in Vadodara | Industrial Electrical Contractors | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/industrial-electrical-contractors/ht-power-connection-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/industrial-electrical-contractors/ht-power-connection-vadodara",
