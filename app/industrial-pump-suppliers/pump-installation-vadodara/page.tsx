...
export const metadata: Metadata = {
  title: "pump installation in Vadodara | Industrial Pump Suppliers | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/industrial-pump-suppliers/pump-installation-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/industrial-pump-suppliers/pump-installation-vadodara",
