...
export const metadata: Metadata = {
  title: "Damp proof course in Vadodara | Waterproofing Services | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/waterproofing-services/damp-proof-course-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/waterproofing-services/damp-proof-course-vadodara",
