...
export const metadata: Metadata = {
  title: "Personal loan interest rate in Vadodara | Loan Consultancy Services | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/loan-consultancy-services/personal-loan-interest-rate-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/loan-consultancy-services/personal-loan-interest-rate-vadodara",
