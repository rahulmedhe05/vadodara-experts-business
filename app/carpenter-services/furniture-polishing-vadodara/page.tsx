...
export const metadata: Metadata = {
  title: "Furniture polishing in Vadodara | Carpenter Services | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/carpenter-services/furniture-polishing-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/carpenter-services/furniture-polishing-vadodara",
