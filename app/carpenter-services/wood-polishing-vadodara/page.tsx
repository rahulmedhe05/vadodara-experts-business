...
export const metadata: Metadata = {
  title: "Wood polishing in Vadodara | Carpenter Services | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/carpenter-services/wood-polishing-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/carpenter-services/wood-polishing-vadodara",
