...
export const metadata: Metadata = {
  title: "Table repair in Vadodara | Carpenter Services | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/carpenter-services/table-repair-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/carpenter-services/table-repair-vadodara",
