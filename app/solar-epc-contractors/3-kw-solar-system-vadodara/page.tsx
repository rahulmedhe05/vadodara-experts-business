...
export const metadata: Metadata = {
  title: "3 kW solar system in Vadodara | Solar EPC Contractors | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/solar-epc-contractors/3-kw-solar-system-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/solar-epc-contractors/3-kw-solar-system-vadodara",
