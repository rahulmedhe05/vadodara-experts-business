...
export const metadata: Metadata = {
  title: "solar street light in Vadodara | Solar EPC Contractors | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/solar-epc-contractors/solar-street-light-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/solar-epc-contractors/solar-street-light-vadodara",
