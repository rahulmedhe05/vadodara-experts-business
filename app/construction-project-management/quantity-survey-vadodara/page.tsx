...
export const metadata: Metadata = {
  title: "quantity survey in Vadodara | Construction Project Management | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/construction-project-management/quantity-survey-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/construction-project-management/quantity-survey-vadodara",
