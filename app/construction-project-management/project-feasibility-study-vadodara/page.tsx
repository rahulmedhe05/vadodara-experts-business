...
export const metadata: Metadata = {
  title: "project feasibility study in Vadodara | Construction Project Management | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/construction-project-management/project-feasibility-study-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/construction-project-management/project-feasibility-study-vadodara",
