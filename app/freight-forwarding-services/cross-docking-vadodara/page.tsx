...
export const metadata: Metadata = {
  title: "Cross docking in Vadodara | Freight Forwarding Services | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/freight-forwarding-services/cross-docking-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/freight-forwarding-services/cross-docking-vadodara",
