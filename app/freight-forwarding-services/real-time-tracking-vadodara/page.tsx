...
export const metadata: Metadata = {
  title: "Real time tracking in Vadodara | Freight Forwarding Services | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/freight-forwarding-services/real-time-tracking-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/freight-forwarding-services/real-time-tracking-vadodara",
