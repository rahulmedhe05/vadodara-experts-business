...
export const metadata: Metadata = {
  title: "Bonded warehouse in Vadodara | Freight Forwarding Services | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/freight-forwarding-services/bonded-warehouse-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/freight-forwarding-services/bonded-warehouse-vadodara",
