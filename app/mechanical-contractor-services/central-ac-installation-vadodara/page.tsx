...
export const metadata: Metadata = {
  title: "central AC installation in Vadodara | Mechanical Contractor Services | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/mechanical-contractor-services/central-ac-installation-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/mechanical-contractor-services/central-ac-installation-vadodara",
