...
export const metadata: Metadata = {
  title: "Fridge not cooling in Vadodara | Refrigerator Services | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/refrigerator-services/fridge-not-cooling-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/refrigerator-services/fridge-not-cooling-vadodara",
