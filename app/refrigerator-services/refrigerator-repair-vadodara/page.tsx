...
export const metadata: Metadata = {
  title: "Refrigerator repair in Vadodara | Refrigerator Services | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/refrigerator-services/refrigerator-repair-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/refrigerator-services/refrigerator-repair-vadodara",
