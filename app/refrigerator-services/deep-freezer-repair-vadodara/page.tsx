...
export const metadata: Metadata = {
  title: "Deep freezer repair in Vadodara | Refrigerator Services | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/refrigerator-services/deep-freezer-repair-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/refrigerator-services/deep-freezer-repair-vadodara",
