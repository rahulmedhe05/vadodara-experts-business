...
export const metadata: Metadata = {
  title: "Fridge shelf replacement in Vadodara | Refrigerator Services | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/refrigerator-services/fridge-shelf-replacement-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/refrigerator-services/fridge-shelf-replacement-vadodara",
