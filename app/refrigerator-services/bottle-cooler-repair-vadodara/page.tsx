...
export const metadata: Metadata = {
  title: "Bottle cooler repair in Vadodara | Refrigerator Services | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/refrigerator-services/bottle-cooler-repair-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/refrigerator-services/bottle-cooler-repair-vadodara",
