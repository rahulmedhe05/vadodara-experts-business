...
export const metadata: Metadata = {
  title: "Fridge compressor price in Vadodara | Refrigerator Services | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/refrigerator-services/fridge-compressor-price-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/refrigerator-services/fridge-compressor-price-vadodara",
