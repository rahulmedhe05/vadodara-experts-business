...
export const metadata: Metadata = {
  title: "Solar EMI in Vadodara | Solar Panel Installation | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/solar-panel-installation/solar-emi-vadodara" },
  openGraph: {
    title: "Solar EMI in Vadodara | VadodaraExperts",
    description: "Professional solar emi services in Vadodara from verified experts.",
    url: "https://vadodaraexperts.com/solar-panel-installation/solar-emi-vadodara",
