...
export const metadata: Metadata = {
  title: "RO plant in Vadodara | Industrial RO Plants | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/industrial-ro-plants/ro-plant-vadodara" },
  openGraph: {
    title: "RO plant in Vadodara | VadodaraExperts",
    description: "Professional ro plant services in Vadodara from verified experts.",
    url: "https://vadodaraexperts.com/industrial-ro-plants/ro-plant-vadodara",
