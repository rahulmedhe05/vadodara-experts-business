...
export const metadata: Metadata = {
  title: "Real estate lawyer in Vadodara | Legal Services | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/legal-services/real-estate-lawyer-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/legal-services/real-estate-lawyer-vadodara",
