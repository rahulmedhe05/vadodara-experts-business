...
export const metadata: Metadata = {
  title: "Builder complaint lawyer in Vadodara | Legal Services | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/legal-services/builder-complaint-lawyer-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/legal-services/builder-complaint-lawyer-vadodara",
