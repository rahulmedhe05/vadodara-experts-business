...
export const metadata: Metadata = {
  title: "property document verification in Vadodara | Real Estate Legal Advisory | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/real-estate-legal-advisory/property-document-verification-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/real-estate-legal-advisory/property-document-verification-vadodara",
