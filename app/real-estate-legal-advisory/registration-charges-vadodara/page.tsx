...
export const metadata: Metadata = {
  title: "registration charges in Vadodara | Real Estate Legal Advisory | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/real-estate-legal-advisory/registration-charges-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/real-estate-legal-advisory/registration-charges-vadodara",
