...
export const metadata: Metadata = {
  title: "release deed in Vadodara | Real Estate Legal Advisory | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/real-estate-legal-advisory/release-deed-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/real-estate-legal-advisory/release-deed-vadodara",
