...
export const metadata: Metadata = {
  title: "encumbrance certificate in Vadodara | Real Estate Legal Advisory | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/real-estate-legal-advisory/encumbrance-certificate-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/real-estate-legal-advisory/encumbrance-certificate-vadodara",
