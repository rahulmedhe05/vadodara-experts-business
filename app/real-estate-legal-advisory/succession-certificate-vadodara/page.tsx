...
export const metadata: Metadata = {
  title: "succession certificate in Vadodara | Real Estate Legal Advisory | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/real-estate-legal-advisory/succession-certificate-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/real-estate-legal-advisory/succession-certificate-vadodara",
