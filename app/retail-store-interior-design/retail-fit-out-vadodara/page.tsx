...
export const metadata: Metadata = {
  title: "retail fit out in Vadodara | Retail Store Interior Design | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/retail-store-interior-design/retail-fit-out-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/retail-store-interior-design/retail-fit-out-vadodara",
