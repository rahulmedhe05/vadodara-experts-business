...
export const metadata: Metadata = {
  title: "smoke damper in Vadodara | Fire Safety Systems | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/fire-safety-systems/smoke-damper-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/fire-safety-systems/smoke-damper-vadodara",
