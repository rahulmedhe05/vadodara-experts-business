...
export const metadata: Metadata = {
  title: "Bonded warehouse in Vadodara | Customs Clearance Agents | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/customs-clearance-agents/bonded-warehouse-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/customs-clearance-agents/bonded-warehouse-vadodara",
