...
export const metadata: Metadata = {
  title: "Builder agreement review in Vadodara | Property Legal Services | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/property-legal-services/builder-agreement-review-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/property-legal-services/builder-agreement-review-vadodara",
