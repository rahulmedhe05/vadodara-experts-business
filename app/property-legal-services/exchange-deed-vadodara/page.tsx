...
export const metadata: Metadata = {
  title: "Exchange deed in Vadodara | Property Legal Services | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/property-legal-services/exchange-deed-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/property-legal-services/exchange-deed-vadodara",
