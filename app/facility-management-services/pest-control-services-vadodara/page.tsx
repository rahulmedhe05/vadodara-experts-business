...
export const metadata: Metadata = {
  title: "Pest control services in Vadodara | Facility Management Services | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/facility-management-services/pest-control-services-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/facility-management-services/pest-control-services-vadodara",
