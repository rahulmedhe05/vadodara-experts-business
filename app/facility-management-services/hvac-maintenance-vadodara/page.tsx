...
export const metadata: Metadata = {
  title: "HVAC maintenance in Vadodara | Facility Management Services | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/facility-management-services/hvac-maintenance-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/facility-management-services/hvac-maintenance-vadodara",
