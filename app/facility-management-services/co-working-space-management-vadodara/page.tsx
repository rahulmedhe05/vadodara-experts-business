...
export const metadata: Metadata = {
  title: "Co working space management in Vadodara | Facility Management Services | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/facility-management-services/co-working-space-management-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/facility-management-services/co-working-space-management-vadodara",
