...
export const metadata: Metadata = {
  title: "UPS maintenance in Vadodara | Facility Management Services | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/facility-management-services/ups-maintenance-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/facility-management-services/ups-maintenance-vadodara",
