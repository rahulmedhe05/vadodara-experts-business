...
export const metadata: Metadata = {
  title: "Residential property management in Vadodara | Facility Management Services | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/facility-management-services/residential-property-management-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/facility-management-services/residential-property-management-vadodara",
