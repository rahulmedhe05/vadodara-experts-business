...
export const metadata: Metadata = {
  title: "food grade warehouse in Vadodara | Warehouse Construction | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/warehouse-construction/food-grade-warehouse-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/warehouse-construction/food-grade-warehouse-vadodara",
