...
export const metadata: Metadata = {
  title: "warehouse with dock in Vadodara | Warehouse Construction | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/warehouse-construction/warehouse-with-dock-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/warehouse-construction/warehouse-with-dock-vadodara",
