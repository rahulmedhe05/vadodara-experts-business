...
export const metadata: Metadata = {
  title: "modern warehouse in Vadodara | Warehouse Construction | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/warehouse-construction/modern-warehouse-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/warehouse-construction/modern-warehouse-vadodara",
