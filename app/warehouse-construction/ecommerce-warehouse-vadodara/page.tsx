...
export const metadata: Metadata = {
  title: "ecommerce warehouse in Vadodara | Warehouse Construction | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/warehouse-construction/ecommerce-warehouse-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/warehouse-construction/ecommerce-warehouse-vadodara",
