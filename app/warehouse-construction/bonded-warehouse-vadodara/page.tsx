...
export const metadata: Metadata = {
  title: "bonded warehouse in Vadodara | Warehouse Construction | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/warehouse-construction/bonded-warehouse-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/warehouse-construction/bonded-warehouse-vadodara",
