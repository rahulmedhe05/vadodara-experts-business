...
export const metadata: Metadata = {
  title: "net zero building in Vadodara | Green Building Consultancy | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/green-building-consultancy/net-zero-building-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/green-building-consultancy/net-zero-building-vadodara",
