...
export const metadata: Metadata = {
  title: "Landscape architect in Vadodara | Landscape Architecture | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/landscape-architecture/landscape-architect-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/landscape-architecture/landscape-architect-vadodara",
