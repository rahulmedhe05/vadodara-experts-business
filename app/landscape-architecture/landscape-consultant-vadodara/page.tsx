...
export const metadata: Metadata = {
  title: "Landscape consultant in Vadodara | Landscape Architecture | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/landscape-architecture/landscape-consultant-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/landscape-architecture/landscape-consultant-vadodara",
