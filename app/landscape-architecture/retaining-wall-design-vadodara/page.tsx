...
export const metadata: Metadata = {
  title: "Retaining wall design in Vadodara | Landscape Architecture | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/landscape-architecture/retaining-wall-design-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/landscape-architecture/retaining-wall-design-vadodara",
