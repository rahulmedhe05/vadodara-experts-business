...
export const metadata: Metadata = {
  title: "Japanese garden design in Vadodara | Landscape Architecture | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/landscape-architecture/japanese-garden-design-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/landscape-architecture/japanese-garden-design-vadodara",
