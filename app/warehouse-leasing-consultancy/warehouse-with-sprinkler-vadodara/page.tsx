...
export const metadata: Metadata = {
  title: "warehouse with sprinkler in Vadodara | Warehouse Leasing Consultancy | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/warehouse-leasing-consultancy/warehouse-with-sprinkler-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/warehouse-leasing-consultancy/warehouse-with-sprinkler-vadodara",
