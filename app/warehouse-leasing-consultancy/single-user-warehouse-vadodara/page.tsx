...
export const metadata: Metadata = {
  title: "single user warehouse in Vadodara | Warehouse Leasing Consultancy | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/warehouse-leasing-consultancy/single-user-warehouse-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/warehouse-leasing-consultancy/single-user-warehouse-vadodara",
