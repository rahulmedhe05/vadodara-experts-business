...
export const metadata: Metadata = {
  title: "multi user warehouse in Vadodara | Warehouse Leasing Consultancy | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/warehouse-leasing-consultancy/multi-user-warehouse-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/warehouse-leasing-consultancy/multi-user-warehouse-vadodara",
