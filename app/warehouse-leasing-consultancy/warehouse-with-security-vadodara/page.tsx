...
export const metadata: Metadata = {
  title: "warehouse with security in Vadodara | Warehouse Leasing Consultancy | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/warehouse-leasing-consultancy/warehouse-with-security-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/warehouse-leasing-consultancy/warehouse-with-security-vadodara",
