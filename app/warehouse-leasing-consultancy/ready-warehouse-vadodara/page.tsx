...
export const metadata: Metadata = {
  title: "ready warehouse in Vadodara | Warehouse Leasing Consultancy | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/warehouse-leasing-consultancy/ready-warehouse-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/warehouse-leasing-consultancy/ready-warehouse-vadodara",
