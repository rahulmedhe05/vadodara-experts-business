...
export const metadata: Metadata = {
  title: "Pre wedding shoot location in Vadodara | Wedding Planning Services | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/wedding-planning-services/pre-wedding-shoot-location-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/wedding-planning-services/pre-wedding-shoot-location-vadodara",
