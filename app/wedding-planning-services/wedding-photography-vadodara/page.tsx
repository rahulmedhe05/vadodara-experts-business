...
export const metadata: Metadata = {
  title: "Wedding photography in Vadodara | Wedding Planning Services | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/wedding-planning-services/wedding-photography-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/wedding-planning-services/wedding-photography-vadodara",
