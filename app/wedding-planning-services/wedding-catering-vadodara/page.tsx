...
export const metadata: Metadata = {
  title: "Wedding catering in Vadodara | Wedding Planning Services | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/wedding-planning-services/wedding-catering-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/wedding-planning-services/wedding-catering-vadodara",
