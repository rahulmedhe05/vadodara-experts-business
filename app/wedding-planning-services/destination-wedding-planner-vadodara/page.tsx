...
export const metadata: Metadata = {
  title: "Destination wedding planner in Vadodara | Wedding Planning Services | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/wedding-planning-services/destination-wedding-planner-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/wedding-planning-services/destination-wedding-planner-vadodara",
