...
export const metadata: Metadata = {
  title: "Alexa integration in Vadodara | Smart Home Construction | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/smart-home-construction/alexa-integration-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/smart-home-construction/alexa-integration-vadodara",
