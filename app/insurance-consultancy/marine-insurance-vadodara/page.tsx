...
export const metadata: Metadata = {
  title: "Marine insurance in Vadodara | Insurance Consultancy | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/insurance-consultancy/marine-insurance-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/insurance-consultancy/marine-insurance-vadodara",
