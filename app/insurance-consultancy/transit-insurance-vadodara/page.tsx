...
export const metadata: Metadata = {
  title: "Transit insurance in Vadodara | Insurance Consultancy | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/insurance-consultancy/transit-insurance-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/insurance-consultancy/transit-insurance-vadodara",
