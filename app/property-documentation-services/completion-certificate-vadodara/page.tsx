...
export const metadata: Metadata = {
  title: "Completion certificate in Vadodara | Property Documentation Services | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/property-documentation-services/completion-certificate-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/property-documentation-services/completion-certificate-vadodara",
