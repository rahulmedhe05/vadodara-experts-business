...
export const metadata: Metadata = {
  title: "Will drafting in Vadodara | Property Documentation Services | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/property-documentation-services/will-drafting-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/property-documentation-services/will-drafting-vadodara",
