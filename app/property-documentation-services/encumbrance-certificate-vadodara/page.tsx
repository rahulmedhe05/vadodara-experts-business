...
export const metadata: Metadata = {
  title: "Encumbrance certificate in Vadodara | Property Documentation Services | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/property-documentation-services/encumbrance-certificate-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/property-documentation-services/encumbrance-certificate-vadodara",
