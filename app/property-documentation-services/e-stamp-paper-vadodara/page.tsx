...
export const metadata: Metadata = {
  title: "E stamp paper in Vadodara | Property Documentation Services | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/property-documentation-services/e-stamp-paper-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/property-documentation-services/e-stamp-paper-vadodara",
