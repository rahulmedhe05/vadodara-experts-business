...
export const metadata: Metadata = {
  title: "Legal heir certificate in Vadodara | Property Documentation Services | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/property-documentation-services/legal-heir-certificate-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/property-documentation-services/legal-heir-certificate-vadodara",
