...
export const metadata: Metadata = {
  title: "Release deed in Vadodara | Property Documentation Services | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/property-documentation-services/release-deed-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/property-documentation-services/release-deed-vadodara",
