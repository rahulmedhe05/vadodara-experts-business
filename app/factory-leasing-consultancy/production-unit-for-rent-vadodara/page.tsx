...
export const metadata: Metadata = {
  title: "production unit for rent in Vadodara | Factory Leasing Consultancy | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/factory-leasing-consultancy/production-unit-for-rent-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/factory-leasing-consultancy/production-unit-for-rent-vadodara",
