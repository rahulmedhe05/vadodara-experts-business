...
export const metadata: Metadata = {
  title: "Raft foundation in Vadodara | Civil Contractors | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/civil-contractors/raft-foundation-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/civil-contractors/raft-foundation-vadodara",
