...
export const metadata: Metadata = {
  title: "Wall putty work in Vadodara | Civil Contractors | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/civil-contractors/wall-putty-work-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/civil-contractors/wall-putty-work-vadodara",
