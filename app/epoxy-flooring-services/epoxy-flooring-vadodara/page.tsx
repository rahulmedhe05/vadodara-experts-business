...
export const metadata: Metadata = {
  title: "epoxy flooring in Vadodara | Epoxy Flooring Services | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/epoxy-flooring-services/epoxy-flooring-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/epoxy-flooring-services/epoxy-flooring-vadodara",
