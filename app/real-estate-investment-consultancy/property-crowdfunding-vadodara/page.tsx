...
export const metadata: Metadata = {
  title: "property crowdfunding in Vadodara | Real Estate Investment Consultancy | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/real-estate-investment-consultancy/property-crowdfunding-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/real-estate-investment-consultancy/property-crowdfunding-vadodara",
