...
export const metadata: Metadata = {
  title: "Encumbrance certificate in Vadodara | Mortgage Loan Consultancy | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/mortgage-loan-consultancy/encumbrance-certificate-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/mortgage-loan-consultancy/encumbrance-certificate-vadodara",
