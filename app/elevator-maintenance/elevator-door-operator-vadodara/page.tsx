...
export const metadata: Metadata = {
  title: "elevator door operator in Vadodara | Elevator Maintenance | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/elevator-maintenance/elevator-door-operator-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/elevator-maintenance/elevator-door-operator-vadodara",
