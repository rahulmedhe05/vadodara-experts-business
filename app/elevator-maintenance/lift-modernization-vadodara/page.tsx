...
export const metadata: Metadata = {
  title: "lift modernization in Vadodara | Elevator Maintenance | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/elevator-maintenance/lift-modernization-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/elevator-maintenance/lift-modernization-vadodara",
