...
export const metadata: Metadata = {
  title: "lift motor repair in Vadodara | Elevator Maintenance | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/elevator-maintenance/lift-motor-repair-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/elevator-maintenance/lift-motor-repair-vadodara",
