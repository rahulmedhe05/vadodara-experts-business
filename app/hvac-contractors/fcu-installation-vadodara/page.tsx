...
export const metadata: Metadata = {
  title: "FCU installation in Vadodara | HVAC Contractors | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/hvac-contractors/fcu-installation-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/hvac-contractors/fcu-installation-vadodara",
