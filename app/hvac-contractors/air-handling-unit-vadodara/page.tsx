...
export const metadata: Metadata = {
  title: "air handling unit in Vadodara | HVAC Contractors | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/hvac-contractors/air-handling-unit-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/hvac-contractors/air-handling-unit-vadodara",
