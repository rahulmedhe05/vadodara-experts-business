...
export const metadata: Metadata = {
  title: "erection drawing in Vadodara | Steel Structure Construction | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/steel-structure-construction/erection-drawing-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/steel-structure-construction/erection-drawing-vadodara",
