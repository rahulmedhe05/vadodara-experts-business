...
export const metadata: Metadata = {
  title: "PEB manufacturer in Vadodara | Steel Structure Construction | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/steel-structure-construction/peb-manufacturer-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/steel-structure-construction/peb-manufacturer-vadodara",
