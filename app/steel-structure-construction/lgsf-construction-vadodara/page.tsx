...
export const metadata: Metadata = {
  title: "LGSF construction in Vadodara | Steel Structure Construction | VadodaraExperts",
  ...
  alternates: { canonical: "https://vadodaraexperts.com/steel-structure-construction/lgsf-construction-vadodara" },
  openGraph: {
    ...
    url: "https://vadodaraexperts.com/steel-structure-construction/lgsf-construction-vadodara",
